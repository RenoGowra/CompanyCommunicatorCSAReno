...
//Added: sending onBehalfOfAuthor feature
...
//TODO: use of localImagePath state
export interface formState {
    ...
    selectedOnBehalfOf?: boolean, //selectedonbehalfofAuthor
...
class NewMessage extends React.Component<INewMessageProps, formState> {
    ...
    public setDefaultCard = (card: any) => {
        ...
        const subtitleAsString = this.localize("SubTitle");
...
//Added: handleUploadClick for csv file upload
    ...
    // Added:handler for onBehalfOfChanged - Author
